...
// Invisible AP terminates at the same axon-to-terminal handoff as the
// visible AP so Na⁺ influx spans the full shaft without entering boutons.
const INVISIBLE_AP_END = AXON_TERMINAL_START;
